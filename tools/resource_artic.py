...
UA = "ScreenDocent/1.0 (https://github.com/AiwendilInTheWoods/Screen-Docent; jmyost@gmail.com) re-source"
AIC_UA = "ScreenDocent (jmyost@gmail.com)"  # AIC asks clients to set this
